/**
 * @description 
 * calculate BMI using formula : BMI(kg/m ) = mass(kg) / height(m)
 * eval BMI Category and the Health Risk
 * @param {*} person {source object}
 * @param {*} inputHeight {height in meter}
 * @param {*} inputWeight {weight in kg}
 */
